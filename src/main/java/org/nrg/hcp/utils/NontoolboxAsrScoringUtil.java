 ...
 */
public class NontoolboxAsrScoringUtil {
	...
	// Computed internalizing sum
    private static final String[] COMP_TOTAL_ITEMS = new String[] {"ASR_cmp_internalizing_raw","ASR_cmp_externalizing_raw","ASR_cmp_other_raw"};
	...
	public static Map<String,String> computeScores(Map<String,String> rawData) {
		...
		scoreMap.put("ASR_cmp_internalizing_raw",sumDerivedItems(scoreMap,COMP_INTERNALIZING_ITEMS));
		scoreMap.put("ASR_cmp_externalizing_raw",sumDerivedItems(scoreMap,COMP_EXTERNALIZING_ITEMS));
		scoreMap.put("ASR_cmp_other_raw",sumDerivedItems(scoreMap,COMP_OTHER_ITEMS));
		scoreMap.put("ASR_cmp_total_raw",sumDerivedItems(scoreMap,COMP_TOTAL_ITEMS));
		...
		if ((sex.equalsIgnoreCase("M") || sex.equalsIgnoreCase("F")) && age>0) {
			...
			if (sex.equalsIgnoreCase("F") && age>=18 && age<=36) {
				...
				scoreMap.put("ASR_cmp_internalizing_t",computeT(scoreMap,"ASR_cmp_internalizing_raw",T_COMP_INTERNALIZING_F_1835));
				scoreMap.put("ASR_cmp_externalizing_t",computeT(scoreMap,"ASR_cmp_externalizing_raw",T_COMP_EXTERNALIZING_F_1835));
				scoreMap.put("ASR_cmp_total_t",computeT(scoreMap,"ASR_cmp_total_raw",T_COMP_TOTAL_F_1835));
				...
				scoreMap.put("ASR_cmp_internalizing_t",computeT(scoreMap,"ASR_cmp_internalizing_raw",T_COMP_INTERNALIZING_F_3659));
				scoreMap.put("ASR_cmp_externalizing_t",computeT(scoreMap,"ASR_cmp_externalizing_raw",T_COMP_EXTERNALIZING_F_3659));
				scoreMap.put("ASR_cmp_total_t",computeT(scoreMap,"ASR_cmp_total_raw",T_COMP_TOTAL_F_3659));
				...
				scoreMap.put("ASR_cmp_internalizing_t",computeT(scoreMap,"ASR_cmp_internalizing_raw",T_COMP_INTERNALIZING_M_1835));
				scoreMap.put("ASR_cmp_externalizing_t",computeT(scoreMap,"ASR_cmp_externalizing_raw",T_COMP_EXTERNALIZING_M_1835));
				scoreMap.put("ASR_cmp_total_t",computeT(scoreMap,"ASR_cmp_total_raw",T_COMP_TOTAL_M_1835));
				...
				scoreMap.put("ASR_cmp_internalizing_t",computeT(scoreMap,"ASR_cmp_internalizing_raw",T_COMP_INTERNALIZING_M_3659));
				scoreMap.put("ASR_cmp_externalizing_t",computeT(scoreMap,"ASR_cmp_externalizing_raw",T_COMP_EXTERNALIZING_M_3659));
				scoreMap.put("ASR_cmp_total_t",computeT(scoreMap,"ASR_cmp_total_raw",T_COMP_TOTAL_M_3659));
